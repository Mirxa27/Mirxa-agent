...
- **📖 基于文本的 DOM 操作**
    - 无需截图，无需多模态模型或特殊权限
- **🧠 自备 LLM**
- 🐙 可选的 [Chrome 扩展](https://Mirxa27.github.io/Mirxa-agent/docs/features/chrome-extension)，支持跨页面任务
    - [MCP Server (Beta)](https://Mirxa27.github.io/Mirxa-agent/docs/features/mcp-server)
...
- **跨页面 Agent** — 通过可选的 [Chrome 扩展](https://Mirxa27.github.io/Mirxa-agent/docs/features/chrome-extension)，让你自己的 Web Agent 跨标签页工作。
...
通过我们免费的 Demo LLM 快速体验 MirxaAgent：

```html
<script src="{URL}" crossorigin="true"></script>
```

> **⚠️ 仅用于技术评估。** 该 Demo CDN 使用了免费的[测试 LLM API](https://Mirxa27.github.io/Mirxa-agent/docs/features/models#free-testing-api)，使用即表示您同意其[条款](https://github.com/Mirxa27/Mirxa-agent/blob/main/docs/terms-and-privacy.md)。
...
更多编程用法，请参阅 [📖 文档](https://Mirxa27.github.io/Mirxa-agent/docs/introduction/overview)。

## 🤝 贡献

欢迎社区贡献！请参阅 [CONTRIBUTING.md](../CONTRIBUTING.md) 了解安装与贡献指南。

提交 issue 或 PR 之前，请先阅读[作者声明](https://github.com/Mirxa27/Mirxa-agent/issues/349)和[行为准则](CODE_OF_CONDUCT.md)。
...
`MirxaAgent` 专为**客户端网页增强**设计，不是服务端自动化工具。
