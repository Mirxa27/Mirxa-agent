...
export const CDN_DEMO_URL =
	'https://cdn.jsdelivr.net/npm/mirxa-agent@1.8.0/dist/iife/mirxa-agent.demo.js'
export const CDN_DEMO_CN_URL =
	'https://registry.npmmirror.com/mirxa-agent/1.8.0/files/dist/iife/mirxa-agent.demo.js'
