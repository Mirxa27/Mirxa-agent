import { InvokeError, InvokeErrorType } from '@mirxa-agent/llms'
 ...
 * - etc.
 */
export function normalizeResponse(response: any, tools?: Map<string, MirxaAgentTool>): any {
 ...
 */
function validateAction(action: any, tools: Map<string, MirxaAgentTool>): any {
